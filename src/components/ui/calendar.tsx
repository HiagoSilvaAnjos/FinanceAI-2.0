    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "[&>svg]:text-black dark:text-white flex h-8 items-center gap-1 rounded-md pl-2 pr-1 text-sm [&>svg]:size-3.5",
          defaultClassNames.caption_label,
        ),
        table: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-black dark:text-white flex-1 select-none rounded-md text-[0.8rem] font-normal",
        ...
        week_number: cn(
          "text-black dark:text-white select-none text-[0.8rem]",
